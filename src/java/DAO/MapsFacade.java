    ...
    public Object[] getHistoryYears(int latitude, int longitude, int type) {
        ...
        try {
            Query qyears = getEntityManager().createNativeQuery("SELECT m.* FROM("
                    + " (SELECT grid450_id,value_point AS a2000 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2000') a1 "
                    + "NATURAL  JOIN "
                    + " (SELECT 	grid450_id,value_point AS a2001 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2001') a2 "
                    + "NATURAL  JOIN "
                    + " (SELECT 	grid450_id,value_point AS a2002 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2002') a3 "
                    + "NATURAL  JOIN "
                    + " (SELECT 	grid450_id,value_point AS a2003 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2003') a4 "
                    + "NATURAL  JOIN "
                    + " (SELECT 	grid450_id,value_point AS a2004 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2004') a5  "
                    + "NATURAL  JOIN "
                    + " (SELECT 	grid450_id,value_point AS a2005 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2005') a6 "
                    + "NATURAL  JOIN  "
                    + " (SELECT 	grid450_id,value_point AS a2006 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2006') a7 "
                    + "NATURAL  JOIN "
                    + "(SELECT  	grid450_id,value_point AS a2007 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2007') a8 "
                    + "NATURAL  JOIN "
                    + " (SELECT 	grid450_id,value_point AS a2008 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2008') a9 "
                    + "NATURAL  JOIN "
                    + " (SELECT 	grid450_id,value_point AS a2009 FROM  	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2009') a10 "
                    + "NATURAL  JOIN  "
                    + " (SELECT 	grid450_id,value_point AS a2010 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2010') a11  "
                    + "NATURAL  JOIN  "
                    + "  (SELECT 	grid450_id,value_point AS a2011 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='December') a12 "
                    + "  NATURAL  JOIN  "
                    + " (SELECT 	grid450_id,value_point AS a2012 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2012') a13  "
                    + " NATURAL  JOIN  "
                    + " (SELECT 	grid450_id,value_point AS a2013 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2013') a14  "
                    + " NATURAL  JOIN  "
                    + " (SELECT 	grid450_id,value_point AS a2014 FROM 	grid_450 natural join " + typemap + " where latitude_3857=-8676000 and longitude_3857=233550 and tag_time='2014') a15  "
                    + ") as m"
            );
