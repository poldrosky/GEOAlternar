 ...
 */
@Embeddable
public class MapsSolarPK implements Serializable {
    ...
    public MapsSolarPK(int grid450Id, String tagTime) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MapsSolarPK)) {
            return false;
        }
        MapsSolarPK other = (MapsSolarPK) object;
    ...
    public String toString() {
        return "Entidad.MapsSolarPK[ grid450Id=" + grid450Id + ", tagTime=" + tagTime + " ]";
    }
