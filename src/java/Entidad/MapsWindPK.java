 ...
 */
@Embeddable
public class MapsWindPK implements Serializable {
    ...
    public MapsWindPK(int grid450Id, String tagTime) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MapsWindPK)) {
            return false;
        }
        MapsWindPK other = (MapsWindPK) object;
    ...
    public String toString() {
        return "Entidad.MapsWindPK[ grid450Id=" + grid450Id + ", tagTime=" + tagTime + " ]";
    }
